...
public final class ByteArrayBuilder extends OutputStream
{
    ...
    public ByteArrayBuilder(com.fasterxml.jackson.core.util.BufferRecycler br) { this(br, INITIAL_BLOCK_SIZE); }
    ...
    public ByteArrayBuilder(com.fasterxml.jackson.core.util.BufferRecycler br, int firstBlockSize) {
        _bufferRecycler = br;
        _currBlock = (br == null) ? new byte[firstBlockSize] : br.allocByteBuffer(com.fasterxml.jackson.core.util.BufferRecycler.BYTE_WRITE_CONCAT_BUFFER);
    }
    ...
    public void release() {
        ...
        if (_bufferRecycler != null && _currBlock != null) {
            _bufferRecycler.releaseByteBuffer(com.fasterxml.jackson.core.util.BufferRecycler.BYTE_WRITE_CONCAT_BUFFER, _currBlock);
            _currBlock = null;
        }
    }
