...
public final class TextBuffer
{
    ...
    public void releaseBuffers()
    {
        if (_allocator == null) {
            ...
            if (_currentSegment != null) {
                ...
                _allocator.releaseCharBuffer(com.fasterxml.jackson.core.util.BufferRecycler.CHAR_TEXT_BUFFER, buf);
            }
        }
    }
    ...
    {
        if (_allocator != null) {
            return _allocator.allocCharBuffer(com.fasterxml.jackson.core.util.BufferRecycler.CHAR_TEXT_BUFFER, needed);
        }
