    ...
    implements ContextualSerializer
{
    ...
    @Override
    public void serializeWithType(Entry<?, ?> value, JsonGenerator gen, SerializerProvider provider,
     ...
     * provider.
     */
    protected void serializeUsing(Entry<?, ?> value, JsonGenerator jgen, SerializerProvider provider,
